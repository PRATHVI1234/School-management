...
<form method="post" >
    ...
    <?php include('leftbar.php')?>;
		...
		<div id="page-wrapper">
			...
			<div class="col-lg-6">
<select class="form-control" name="course-short" id="cshort"  onchange="showSub(this.value)" requird="required" >
	...
	<br><br><br><br>
      ...
      <textarea class="form-control" rows="3" name="cadd"><?php echo htmlentities($res->cadd);?></textarea>
        ...
        <div class="row">
			...
			<div class="form-group">
		    <div class="panel panel-default">
					<div class="panel-heading">Enter Course Marks</div>
            <!-- /.panel-heading -->
                        <div class="panel-body">
                            <div class="table-responsive">
                                <table class="table">
