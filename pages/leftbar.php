<nav class="navbar navbar-default navbar-static-top" role="navigation"
			...
			<div class="navbar-header">
				...
				<a class="navbar-brand" href="dashboard1.php">Student Management System</a>
			</div>
                ...
                <div class="sidebar-nav navbar-collapse">
                    <ul class="nav" id="side-menu">
                        ...
                        <li>
                   <a href="dashboard1.php"><i class="fa fa-dashboard fa-fw"></i> Dashboard</a>
                        </li>
                        <li>
                 ...
                 <li>
                                ...
                                <li>
                                    <a href="view-subject.php">View</a>
										...
										<li>
											...
											<li>
													<a href="add-faculty.php"><i class="fa fa-bar-chart-o fa-fw"></i>Add Faculty<span class="fa arrow"></span></a>
											</li>
											<li>
													<a href="view-faculty.php"><i class="fa fa-bar-chart-o fa-fw"></i>View Faculty<span class="fa arrow"></span></a>
											</li>
                   <li>
                   ...
                   <li>
                   <a href="notices.php"><i class="fa fa-bar-chart-o fa-fw"></i>Add Notice<span class="fa arrow"></span></a>
                   </li>
                   <li>
                   <a href="feedbacks.php"><i class="fa fa-bar-chart-o fa-fw"></i>Parent Feedbacks<span class="fa arrow"></span></a>
                   </li>
                   <li>
