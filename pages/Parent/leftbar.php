			...
			<div class="navbar-header">
                ...
                <div class="sidebar-nav navbar-collapse">
                 ...
                 <li>
                  ...
                  <li>
                            <a href="feedback.php"><i class="fa fa-bar-chart-o fa-fw"></i>Feedback<span class="fa arrow"></span></a>
                  </li>
                  </li>
                                   <li>
                            <a href="marksheet.php"><i class="fa fa-bar-chart-o fa-fw"></i>view Marksheet</a>
                  </li>
                   <li>
