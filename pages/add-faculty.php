...
if (! (isset ( $_SESSION ['login'] ))) {
  ...
  if(isset($_POST['submit'])){
	...
	$obj->faculty($_POST['course'],$_POST['coursefull'],$_POST['sub1'],$_POST['sub2'],$_POST['sub3']);
...
<form method="post" >
	<div id="wrapper">
							...
							<div class="row">
						 	<div class="col-lg-10">
										...
										<div class="form-group">
											<div class="col-lg-4">
					 <label>Faculty Name<span id="" style="font-size:11px;color:Red">*</span>	</label>
											</div>

			<div class="col-lg-6">
				<input class="form-control" id="cshort" name="course" required="required">
		...
		<div class="form-group">
		<div class="col-lg-4">
		<label>Mob No.<span id="" style="font-size:11px;color:red">*</span></label>
		</div>
		<div class="col-lg-6">
			<input class="form-control" id="cfull" name="coursefull" required="required">
	...
	<br><br><br>
	<select name="opt" style="display: none">
