...
if (! (isset ( $_SESSION ['login'] ))) {
	...
	if(isset($_GET['del']))
    {
		  ...
		  $obj->del_faculty(intval($_GET['del']));
    }
     ...
     <?php include('leftbar.php')?>;
        ...
        <div id="page-wrapper">
            ...
            <div class="row">
             ...
             <td><?php echo htmlentities(strtoupper($res->fname));?></td>

	  <td><?php echo htmlentities($res->fmob);?></td>
      ...
      <td>&nbsp;&nbsp;<a href="edit-faculty.php?sid=<?php echo htmlentities($res->subid);?>">
	  <p class="fa fa-edit"></p></a> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
      <a href="view-faculty.php?del=<?php echo htmlentities($res->subid); ?>">
