...
if(isset($_POST['submit'])){
	...
	$obj=new DbFunction();
	$obj->feedback($_POST['name'],$_POST['cdate'],$_POST['course-short']);
...
<!--nav-->
							...
							<div class="row">
						 	<div class="col-lg-10">
										...
										<div class="form-group">
											<div class="col-lg-4">
												 <label>Name Of Student<span id="" style="font-size:11px;color:red">*</span>	</label>
											</div>
											<div class="col-lg-6">
											<input class="form-control" name="name" id="name" required="required"  onblur="courseAvailability()">       
											  <span id="course-availability-status" style="font-size:12px;"></span>				
										</div>
										<div class="col-lg-4">
												 <label>feedback<span id="" style="font-size:11px;color:red">*</span>	</label>
											</div>
											<div class="col-lg-6">
	...
	<input class="form-control" value="<?php echo date('d-m-Y');?>" readonly="readonly" name="cdate">
		...
		<br><br>		
							...
							<input type="submit" class="btn btn-primary" name="submit" value="Post"></button>
											</div>
